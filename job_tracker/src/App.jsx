...
import { Briefcase, MapPin, FileText, Phone } from "lucide-react";
...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {jobs
          ...
          .map((job) => (
            <div
              key={job._id}
              className="bg-white rounded-2xl shadow-lg border border-gray-200 p-5 hover:shadow-xl transition flex flex-col justify-between"
            >
              <div>
      ...
      {/* Add Job Form Modal */}
      {showForm && <AddJobForm onClose={() => setShowForm(false)} onAdd={addJob} />}
    </div>
  );
};
